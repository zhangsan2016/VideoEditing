...
/*        Uri uri = ContactsContract.Data.CONTENT_URI;
    ...
    private  void getVCFHashtable() {
     ...
     Uri entityUri = Uri.withAppendedPath(this.mUriContact, ContactsContract.Contacts.Entity.CONTENT_DIRECTORY);
     Cursor c = mContentResolver.query(entityUri,
              new String[]{RawContacts.SOURCE_ID, ContactsContract.Contacts.Entity.DATA_ID, ContactsContract.Contacts.Entity.MIMETYPE, ContactsContract.Contacts.Entity.DATA1},
              null, null, null);
     mBalance.clear();
     try {
         while (c.moveToNext()) {
